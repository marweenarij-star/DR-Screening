// Inspect SQLite DB structure and sample data
// Usage: node scripts/inspect-sqlite-db.js

const sqlite3 = require('sqlite3').verbose();
const path = require('path');
const fs = require('fs');

const dbPath = path.join(__dirname, '..', 'backend', 'dr_screening.db');
...
(async () => {
  try {
    ...
    // Show exams that might be pending (grade = -1) and doctor mapping
